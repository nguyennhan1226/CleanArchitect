...
namespace HR.LeaveManagement.BlazorUI.Services
{
    public class LeaveTypeService : BaseHttpService, ILeaveTypeService
    {
        ...
        public LeaveTypeService(IClient client, IMapper mapper, ILocalStorageService localStorageService, ILoggerFactory loggerFactory) 
        ...
        public async Task<Response<Guid>> CreateLeaveType(LeaveTypeVM leaveType)
        {
            try
            {
                await AddBearerToken(); // ✅ Thêm await
        ...
        public async Task<Response<Guid>> UpdateLeaveType(int id, LeaveTypeVM leaveType)
        {
            try
            {
                ...
                await _client.LeaveTypesPUTAsync(id.ToString(), updatedLeaveTypeCommand);
                return new Response<Guid> { Success = true };
            }
            catch (ApiException apiException)
            {
