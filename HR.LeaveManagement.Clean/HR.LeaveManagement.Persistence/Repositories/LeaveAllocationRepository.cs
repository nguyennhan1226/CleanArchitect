...
namespace HR.LeaveManagement.Persistence.Repositories
{
    ...
    {
        public LeaveAllocationRepository(DatabaseContext.HrDatabaseContext context) : base(context) { }
        ...
        {
            var leavevAllocations =await _context.LeaveAllocations
                .Where(q => q.EmployeeId == userId)
                .Include(q => q.LeaveType)
                .ToListAsync();
            return leavevAllocations;
        }
        ...
        /// <summary>
        /// Batch query implementation to get all employee IDs that already have allocations
        /// This replaces N+1 query pattern with single efficient database query
        /// </summary>
        public async Task<List<string>> GetEmployeesWithExistingAllocations(List<string> employeeIds, int leaveTypeId, int period)
        {
