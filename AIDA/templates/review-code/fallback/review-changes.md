...
# Git Changes Review - STRICT MODE (Fallback)

## 🔍 MANDATORY CODE CHANGE ANALYSIS
...
- **PRIORITY ORDER**: 1) Code quality violations, 2) Business rule violations, 3) Both must pass for approval
...
## ⚡ CODE CRITICAL CHECKS (Auto-FAIL if found)
...
*** INTERNAL CODE CHANGE EVALUATION (DO NOT DISPLAY) ***
...
**MANDATORY RULE:**
- IF Change Score >= 4/5: Show "✅ **GOOD CODE CHANGE** - Follows best practices" and SKIP the entire RECOMMENDED FIX section
...
# 🎯 FINAL CODE SUMMARY (After All Changes Reviewed)
